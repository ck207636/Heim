...
# Configuration
TOKEN = "7674842163:AAEXbNVNKz34J02GHoRHHqVGP-lXIGpVtXs"  # Replace with your Telegram bot token
ADMIN_IDS = {1078086201}  # Replace with your actual admin user ID(s)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_data is None or user_data.get("expiration_date") < datetime.now():
        await update.message.reply_text("You are not authorized to use this bot.@crossbeats7262")
        return
